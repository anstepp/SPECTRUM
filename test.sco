...
rtsetparams(44100, 2)
//you need the ./libSPECTRUM because this isn't part of the distribution
load("./libSPECTRUM.so")
...
for (st = 0; st < 200; st += step) {
   ...
   env = maketable("curve", 1000, 0,1,2, 990,0.5,2 1000,0)
   freq = irand(880, 1270)
   ...
   table = maketable("curve", "nonorm", 1000, 
                     0,irand(0,200),2, 
                     irand(1,150),irand(0,50),2, 
                     irand(125, 400),irand(100,300),2, 
                     irand(600,700),0,2, 
                     irand(800,900),irand(100,400),2,
                     901,200,2, 
                     irand(975,990),0,0, 
                     1000,0)
   //this table determines when the partials begin
